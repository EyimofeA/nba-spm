...
SKILL_SPECS: tuple[SkillSpec, ...] = (
    ...
    SkillSpec("rim_points_saved", "Rim points saved", "defense", "continuous", "points_per_100", value_column="rim_points_saved_p100", exposure_column="DefPoss", source_family="defensive_tracking", definition="Empirical-Bayes stabilized rim points saved per 100 defensive possessions. Raw points saved are two times defended rim attempts times expected minus actual rim field-goal percentage."),
